...
public class DroneScout : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        StartCoroutine(ActionSequence(initialPos - new Vector3(100,0,0)));
    }
    ...
    private IEnumerator ActionSequence(Vector3 targetPos)
    {
        ...
        yield return StartCoroutine(MoveOverTime(targetPos, duration));
